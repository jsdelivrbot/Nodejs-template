...
if(node_env === 'development') {
  // use localConfig file
	...
	settings.windServiceURL = devConfig.windServiceURL;
	settings.partnerURL = devConfig.partnerURL;
	settings.databaseURL = devConfig.databaseURL;
	...
	settings.windServiceURL = process.env.windServiceURL;
	settings.partnerURL = process.env.partnerURL;
	settings.databaseURL = process.env.databaseURL;
}
